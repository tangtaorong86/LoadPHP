...
// 验证码类
class Captcha {
    private $chararr = 'abcdefghkmnprstuvwxyzABCDEFGHKMNPRSTUVWXYZ123456789';
    private $code;
    private $codelen = 4;
    private $width = 120;
    private $height = 40;
    ...
    public function __construct() {
        $this->font = FRAME_PATH.'/Static/Font/Elephant.ttf';
    }
	 ...
	 */
	public function show($name="verify"){
		$this->getImg();
		$_SESSION["verify_".$name] = md5($this->getCode());
	}
	 ...
	 * @author tangtaorong86
	 */
	public function check($value,$name="verify"){
		return md5($value) == $_SESSION["verify_".$name];
	}
